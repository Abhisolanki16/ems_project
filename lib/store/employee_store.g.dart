...
//   @override
//   ObservableList<Datum> get employees {
//     _$employeesAtom.reportRead();
//     return super.employees;
//   }

//   @override
//   set employees(ObservableList<Datum> value) {
...
//   late final _$fetchEmployeesAsyncAction =
//       AsyncAction('_EmployeeStore.fetchEmployees', context: context);

//   @override
//   Future<void> fetchEmployees() {
//     return _$fetchEmployeesAsyncAction.run(() => super.fetchEmployees());
//   }
